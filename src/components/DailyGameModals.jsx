  ...
  const handleToggle = async () => {
    ...
    if (!definition) {
      ...
      try {
        ...
        // Datamuse API: Fast, reliable, no CORS issues, no proxy needed
        ...
        // Extract the first definition from Datamuse response format
        ...
        // Datamuse formats definitions as "n\tdefinition text" -> Strip the POS prefix
